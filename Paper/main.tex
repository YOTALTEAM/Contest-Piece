...
%----------------------------------------------------------------------------------------
\PassOptionsToPackage{quiet}{fontspec} % Quiet fontspec package warning!!!!!!!!! (Dangerous Operation)
\PassOptionsToPackage{quiet}{xeCJK}	% Quiet xeCJK package warning!!!!!!!!! (Dangerous Operation)
...
\usepackage{xeCJK}
\defaultCJKfontfeatures{Script=Default}
...
\usepackage[
	...
	pdfencoding=unicode,
	hypertexnames=true
]{hyperref} % hyper reference package
\usepackage[backend=biber,style=authoryear,backref=true,natbib=true]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA)
% \DeclareOuterCiteDelims{parencite}{\bibopenbracket}{\bibclosebracket}
\addbibresource{reflib.bib} % The filename of the bibliography
...
\author{Chai Hao, \\
		Li Minghao, \\
		Wang Xiyuan} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
\university{\href{https://yotally.github.io/}{Fudan University, Nanjing University}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
...
\noindent We, \authorname, \enquote{\ttitle} and the work presented in it are our own. We confirm that:

\begin{itemize} 
	\item This work was done wholly or mainly while in candidature for a research degree at this University.
	\item Where any part of this thesis has previously been submitted, this has been clearly stated.
...
\printbibliography[heading=bibintoc,title={Bibilography}]
